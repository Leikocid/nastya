...
#define ERROR_ENTRY_NODEF10(id)                           \
    ERROR_ENTRY_NODEF(id + 0), ERROR_ENTRY_NODEF(id + 1), \
...
// #define ERROR_ENTRY_NODEF100(id) - 100 неопределенных элементов таблицы
// ошибок
#define ERROR_ENTRY_NODEF100(id)                                \
    ERROR_ENTRY_NODEF10(id + 0), ERROR_ENTRY_NODEF10(id + 10),  \
